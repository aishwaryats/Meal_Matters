...
// Check if reqlist exists in local storage
  ...
  for(let i=0;i<reqlist.length;i++){
      ...
      <div class="donation-requestbtn button-allign">
                  ...
                  <button type="button" class="btn btn-primary status-buttons" onclick="senddelreq(${i});">Accept</button>
                  <button type="button" class="btn btn-primary status-buttons" id="declineBtn">Decline</button>
                    </div>
              </div>
              ` 
      ;
